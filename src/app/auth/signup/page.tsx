        ...
        return (
            <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
                <div className="text-center space-y-3">
                    ...
                    <p className="text-sm text-white/50">{email}로 인증 메일을 보냈습니다.</p>
                    <Link href="/auth/login" className="block text-xs text-indigo-400 hover:text-indigo-300 mt-4">
                        로그인으로 돌아가기
                    </Link>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
            <div className="w-full max-w-sm space-y-6">
                <div className="text-center">
                    ...
                    <p className="text-sm text-white/50 mt-1">무료로 시작하세요</p>
                </div>
